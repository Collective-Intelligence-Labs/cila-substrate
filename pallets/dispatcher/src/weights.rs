...
//! Autogenerated weights for pallet_event_store
//!
...
/// Weight functions needed for pallet_event_store.
pub trait WeightInfo {
	fn do_something() -> Weight;
	fn cause_error() -> Weight;
}

/// Weights for pallet_event_store using the Substrate node and recommended hardware.
